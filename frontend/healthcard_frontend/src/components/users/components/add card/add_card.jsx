...
const AddCardform = () => {
  ...
  const [addcard_error, setaddcard_error] = useState(false);
  const handleimg = (e) => {
  ...
  const handlesubmit = () => {
    ...
    axios
      .post(apiurl + "/api/users/addcard/", formdata, {
  ...
  return (
    <div className='add_card'>
      ...
      <div>
        ...
        <div className='save'>
          <button onClick={handlesubmit} ref={addbtnref}>
            {loader ? <div className='loader'></div> : "Save"}
          </button>
        </div>
        {addcard_error && <div className='error_input'>Card Added failed</div>}
      </div>
    </div>
  );
};
